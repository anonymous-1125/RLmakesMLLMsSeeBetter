...
FIN_RUN_NAME="stage2-dpo-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-llava"

# or --attn_implementation flash_attention_2 \
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --master_port 12345 \
    ...
    --data_path ./dataset/MMPR-v1.2/dpo_20k.json \
